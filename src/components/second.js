      ...
      <main className="container mx-auto flex flex-col">
        ...
        <div className="sec1 ml-4 flex flex-col tablet:flex-row tablet:container tablet:mx-auto">
          <div className="w-4/5 flex flex-col items-start my-5">
            ...
            <p  style={{ textAlign: 'left' }} className="py-3 text-sm font-mono ">You are just a step away as  schemes are programmes launched by the government to improve the standard of living of all citizens. Government schemes are typically categorised into two main types, i.e. central sector and centrally sponsored schemes</p>
